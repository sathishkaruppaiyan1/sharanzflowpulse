...
export const supabaseOrderService = {
  ...
  ): Promise<{ order: Order; whatsappSuccess: boolean; shopifySuccess: boolean; whatsappError?: string; shopifyError?: string }> {
