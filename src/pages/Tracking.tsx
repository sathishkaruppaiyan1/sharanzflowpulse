        ...
        <div className="flex-1 p-6 bg-gray-50">
          <Card className="max-w-md mx-auto mt-8">
            <CardHeader>
              ...
              <CardDescription>
                Unable to load tracking queue. Please try again.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Add tracking information and manage shipments for orders ready for delivery.
            </p>
          </div>
          ...
          <div className="mb-4">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Tracking Queue</h3>
