  ...
  if (isLoading) {
    return (
      <div className="flex flex-col h-full">
        <Header title="Shipping" showSearch={false} />
        <div className="flex-1 p-6 bg-gray-50">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <Ship className="h-8 w-8 text-gray-400 mx-auto mb-4 animate-pulse" />
              <p className="text-gray-500">Loading shipping data...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 p-6 bg-gray-50">
          <Card className="max-w-md mx-auto mt-8">
            <CardHeader>
              <CardTitle className="text-red-600">Error Loading Shipping Data</CardTitle>
              <CardDescription>
                Unable to load shipping data. Please try again.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Manage completed orders with shipping actions and status updates.
            </p>
          </div>
